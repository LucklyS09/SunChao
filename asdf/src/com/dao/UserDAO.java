...
public class UserDAO {
	...
	public static final String NISHI = "nishi";
	...
	public List<User> findByExample(User instance) {
		...
		try {
			List<User> results = (List<User>) getCurrentSession()
					.createCriteria("com.bean.User").add(create(instance))
					.list();
	...
	public List<User> findByNishi(Object nishi) {
		return findByProperty(NISHI, nishi);
	}
