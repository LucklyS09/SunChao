...
public class ZyAdapter extends BaseAdapter {   
   ...
   public  ZyAdapter(Context context, List<Map<String, Object>> listItems) {   
   ...
   public View getView(int position, View convertView, ViewGroup parent) {   
       ...
       if (convertView == null) {   
           ...
           //获取kt布局文件的视图   
           convertView = listContainer.inflate(R.layout.zy, null);   
           //获取控件对象   
           listItemView.title = (TextView)convertView.findViewById(R.id.text1);           
           listItemView.info = (TextView)convertView.findViewById(R.id.text3);  
           listItemView.text = (TextView)convertView.findViewById(R.id.text2); 
