...
public class Adapter extends BaseAdapter{
    ...
    { 
        ...
        if (convertView == null) 
        { 
            convertView = inflater.inflate(R.layout.class_1, null); 
            viewHolder = new ViewHolder(); 
            viewHolder.title = (TextView) convertView.findViewById(R.id.time1); 
            viewHolder.title2=(TextView)convertView.findViewById(R.id.shu1);
            viewHolder.title3=(TextView)convertView.findViewById(R.id.zuobiao1);
            viewHolder.title4=(TextView)convertView.findViewById(R.id.ren1);
