	...
	public void onCreate(Bundle savedInstanceState) {
		...
		showDialogBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				MyCustomDialog dialog = new MyCustomDialog(Activity_setting.this, "请输入地址",
		...
		showDialogB.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				MyCustomDialog dialog = new MyCustomDialog(Activity_setting.this, "请	输入电话",
						new MyCustomDialog.OnCustomDialogListener() {
		...
		if (resultCode != RESULT_CANCELED) {
			...
			case CAMERA_REQUEST_CODE:
				if (Tools.hasSdcard()) {
					...
					Toast.makeText(Activity_setting.this, "未找到存储卡，无法存储照片！",
